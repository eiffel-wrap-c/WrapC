note
	...
	author: ""
	date: "$Date: 2018-09-07 12:11:49 +0200 (Fri, 07 Sep 2018) $"
	revision: "$Revision: 102139 $"
...
--			dn: detachable READABLE_STRING_32
	...
	launch (a_file_name: READABLE_STRING_GENERAL; args: detachable ITERABLE [READABLE_STRING_GENERAL]; a_working_directory: detachable READABLE_STRING_GENERAL; a_is_hidden: BOOLEAN)
		local
			pf: BASE_PROCESS_FACTORY
			p: BASE_PROCESS
			retried: BOOLEAN
